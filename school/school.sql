...
--
-- 資料表結構 `member` (校園管理系統會員表)
--

CREATE TABLE `member` (
  `id` int(10) UNSIGNED NOT NULL,
  `cdkey` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `member` (`id`, `cdkey`, `password`, `email`, `tel`, `birth`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin123', 'admin@school.edu', '0912345678', '1990-01-01', '2026-05-18 00:00:00', '2026-05-18 00:00:00'),
(2, 'student001', 'pass1234', 'student001@school.edu', '0912345679', '2008-05-15', '2026-05-18 00:00:00', '2026-05-18 00:00:00'),
(3, 'teacher001', 'teach123', 'teacher001@school.edu', '0912345680', '1985-03-20', '2026-05-18 00:00:00', '2026-05-18 00:00:00');
